...
public class RxFlowBenchmarksJunit extends AbstractMuleContextTestCase
{
    ...
    Flow flow;
    SubmissionEmitter<MuleEvent> emitter;
...
//    String processingStrategy = "default";
    ...
    public void setup() throws Exception
    {
        ...
        sensingReplyToHandler = new SensingNullReplyToHandler();
        nonBlockingEvent = new DefaultMuleEvent(new DefaultMuleMessage("Hello World", muleContext), MessageExchangePattern
                .REQUEST_RESPONSE, sensingReplyToHandler, flow);
    ...
    {
        System.out.println(Mono.from(Mono.just(event).as(flow)).get());
    }
