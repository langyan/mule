...
public class DependencyResolver
{
    ...
    public static final class ConfigurationBuilder
    {
        ...
        private TransitiveDependenciesFilterBuilder transitiveDependencyFilterBuilder = new TransitiveDependenciesFilterBuilder(new FalsePredicate<MavenArtifact>());
        ...
        protected LinkedHashMap<MavenArtifact, Set<MavenArtifact>> getAllDependencies()
        {
            return allDependencies;
        }

        protected DependenciesFilterBuilder getDependenciesFilterBuilder()
        {
            return dependenciesFilterBuilder;
        }

        protected TransitiveDependenciesFilterBuilder getTransitiveDependencyFilterBuilder()
        {
            return transitiveDependencyFilterBuilder;
        }

        protected boolean isRootArtifactIncludedInResults()
        {
            return this.rootArtifactIncludedInResults;
        }

        public Predicate<MavenArtifact> getRootArtifactPredicate()
        {
            return rootArtifactPredicate;
        }
    }

    public static final class DependenciesFilterBuilder
    {
        ...
        protected Predicate<MavenArtifact> getPredicate()
        {
            return predicate;
        }
    ...
    public static final class TransitiveDependenciesFilterBuilder
    {
        private Predicate<MavenArtifact> predicate = new TruePredicate<>();
        private boolean includeTransitiveFromFiltered = false;

        protected TransitiveDependenciesFilterBuilder(FalsePredicate<MavenArtifact> predicate)
        {
            this.predicate = predicate;
        }
        ...
        protected boolean isIncludeTransitiveFromFiltered()
        {
